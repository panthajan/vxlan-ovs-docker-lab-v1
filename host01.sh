# Start the VM1/HOST1, update the repository
sudo apt update
...
# Step-03
# one thing to check; as vxlan communicate using udp default port  4789,, but we will use 4799 for safety, check the current status
netstat -ntulp
